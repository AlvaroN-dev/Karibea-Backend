...
public class ErrorResponse {
    ...
    @Schema(description = "Error message", example = "Product not found with ID: 123e4567-e89b-12d3-a456-426614174000")
    private String message;

    @Schema(description = "Request path", example = "/api/v1/products/123e4567-e89b-12d3-a456-426614174000")
    private String path;
